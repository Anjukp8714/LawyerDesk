                ...
                <div className='post1'>
                    ...
                    <div className='left-sec'>
                        <div className='lawyername'>
                            ...
                            <div className='location'> <p>{post.location}</p></div>
                        </div>
                        <div className='content'>  <p>{post.content}</p></div>
                        <div className='specialztn'>
                            <div className='special-hed'><p>Specialized In:</p></div>
                            <div className='links'>
                                <a href=''><span><img src=''/></span> <span>Family Law</span></a>
                                <a href=''><span><img src=''/></span> <span>Corporate Law</span></a>
                                <a href=''><span><img src=''/></span> <span>Property Law</span></a>
                            </div>
                        </div>
                    </div>
                </div>
